...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int playerAnswer1  = currentQuestion.playerAnswer;

                if (playerAnswer1 == -1){
                    AlertDialog.Builder gameOverDialog = new AlertDialog.Builder(MainActivity.this);
                    gameOverDialog.setTitle("Error");
                    gameOverDialog.setMessage("You need to pick something");
    ...
    void displayQuestionsRemaining(int remainingQuestion){
        questionsRemainingTextView.setText(Integer.toString(remainingQuestion));
    }
    ...
    void onAnswerSubmission() {
        ...
        if (questions.size() == 0) {
            ...
            AlertDialog.Builder gameOverDialog = new AlertDialog.Builder(MainActivity.this);
                ...
                gameOverDialog.setMessage(gameOverMessage);
...
// while to reduce to 6 question (array) only, but with all the time the game start i choose 6 random questions
